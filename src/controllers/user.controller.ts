...
import { TCreateUserSchema, TVerifyUserSchema, TForgotPasswordSchema, TResetPasswordSchema } from "../schema/user.schema";
...
class UserController {
  ...
  static getCurrentUserHandler = async function (
    _: Request,
    res: Response
  ) {
